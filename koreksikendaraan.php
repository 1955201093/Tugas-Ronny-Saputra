...
if (isset($_POST['bkoreksi'])) {
  ...
  $sql="SELECT * FROM tbmobil WHERE namakendaraan = '".$namadikoreksi."'";
  $q=$koneksi->query($sql);
...
<div class="container">
  ...
  <form method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nomesinkendaraan" placeholder="Enter nomor mesin" name="nomesinkendaraan" value="<?php echo $rekord['nomesinkendaraan'];?>" readonly>
    </div>
  <div class="form-group">
      <label for="norangkakendaraan">Nomor Rangka Kendaraan:</label>
      <input type="text" class="form-control" id="norangkakendaraan" placeholder="Enter nomor rangka" name="norangkakendaraan" value="<?php echo $rekord['norangkakendaraan'];?>">
    </div>
    <div class="form-group">
...
<div class="form-group">
      <label for="kondisikendaraan">Catatan Kendaraan:</label>
      <input type="text" class="form-control" id="kondisikendaraan" name="kondisikendaraan" value="<?php echo $rekord['kondisikendaraan'];?>">
    </div>
    <div class="form-group">
...
if (isset($_POST['bSimpan'])) {
  ...
  $koneksi=new mysqli("localhost","root","","dbshowroom");
  $sql="UPDATE `kendaraaan` SET `nomesinkendaraan` = '$nomesinkendaraan', `norangkakendaraan` = '$norangkakendaraan', `jeniskendaraan` = '$jeniskendaraan', `namakendaraan` = '$namakendaraan',`tanggalbuat` = '$tanggalbuat', `kondisikendaraan` = '$kondisikendaraan',`nobpkb` = '$nobpkb', `nostnk` = '$nostnk',`statusstnk` = '$statusstnk' WHERE `tbmobil`.`nomesinkendaraan` = '$namakendaraan';";
  $q=$koneksi->query($sql);
  if ($q) {
